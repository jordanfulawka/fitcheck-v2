...
export default function JobList() {
  ...
  return (
    <div className='bg-background h-full p-6'>
      ...
      <div className='bg-white border border-[#dee2e6] rounded-xl shadow-card overflow-hidden h-105'>
        <div className='grid grid-cols-4 bg-[#f8f9fa] px-6 py-3 border-b border-[#dee2e6]'>
